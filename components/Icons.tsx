...
export const NoteIcon: React.FC<IconProps> = ({ className, filled=false }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// 8-sided star for Surah numbering (matches screenshot)
export const NumberingIcon: React.FC<IconProps> = ({ className }) => (
